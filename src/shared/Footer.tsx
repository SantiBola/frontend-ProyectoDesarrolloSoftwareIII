...
import EdicionPanel from '../components/EdicionPanel';
...
export default function Footer() {
  ...
  const whatsappUrl = "https://wa.me/85049791";
  const facebookUrl = "https://www.facebook.com/p/Soda-la-cabaña-100057276797542/?locale=es_LA";
  ...
  return (
    <>
      ...
      {showPanel && (
        <EdicionPanel onClose={() => setShowPanel(false)} />
      )}

      <footer className="bg-stone-900 text-stone-300">
        <div className="max-w-6xl mx-auto px-6 pt-12 pb-6 flex flex-col gap-10 text-center md:text-left md:grid md:grid-cols-4 md:gap-10">
          ...
          <div className="flex flex-col items-center md:items-start">
            <h3 className="text-white font-semibold mb-3">Administración</h3>
            <div className="flex flex-col items-center gap-2 text-sm md:items-start text-stone-400">
              <span>Acceso exclusivo para el equipo de Soda La Cabaña.</span>
              <button
                onClick={() => setShowLogin(true)}
                className="mt-2 flex items-center gap-2 px-4 py-2 bg-stone-700 text-stone-300 text-sm font-semibold rounded-full
                           hover:bg-amber-400 hover:text-stone-900 transition-all duration-200"
              >
